...
const classHasNotification =
  "after:content-[''] after:w-2 after:h-2 after:bg-blue-500 block after:rounded-full after:absolute after:bottom-3/4  after:left-3/4";
...
const Notification: React.FC = () => {
  ...
  return (
    <div className="sm:mr-4 md:mr-6 ml-auto grid place-items-center relative">
      ...
      >
        <IconBell className="fill-rose-600 w-5 h-5 md:w-6 md:h-6 dark:fill-rose-800" />
      </button>
